function [Price]=FFT_CM_Call_VG(Strike,params,T,r,S0)
...
theta=params(2);
k=params(3);
sigmaGBM=params(4); % not zero for extended VG only
V=@(u) -log(1+u.^2*sigma^2*k/2-1i*theta*k*u)/k - sigmaGBM^2*u.^2/2;
